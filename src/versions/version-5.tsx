// Version 5 of the landing page
// Features:
// - Added mailto contact links in navigation and footer
// - Enhanced Digital Twin section placement
// - Updated pricing to show setup fees
// - Improved navigation with contact links
// - Removed demo password protection
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 <li><a href="#" className="text-gray-400 hover:text-white">About Us</a></li>
