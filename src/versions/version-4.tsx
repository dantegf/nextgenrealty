// Version 4 of the landing page
// Features:
// - Added AI Digital Twin as primary benefit
...
// - Updated hero section copy to emphasize Digital Twin
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white">Privacy Policy</a></li </a></li>
